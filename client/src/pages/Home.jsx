...
const Home = () => {
  ...
  return (
    ...
    {/* bg color #282938 */}
          ...
          <Banner />
          <div className='-mt-16'>
          <motion.h2 className=' mt-16 mb-12 text-center text-4xl text-purple-500' variants={fadeIn('left', 0.2)} initial="hidden" whileInView={'show'} viewport={{once:true, amount:0.7}} ref={scrollToRefs.ref2}>House Keeping</motion.h2>
          <div className='px-10'>
          <div className='grid grid-cols-4 gap-8' style={{ overflowX: 'hidden' }}>
              <motion.div variants={fadeIn('right', 0.05)} initial="hidden" whileInView={'show'} viewport={{once:true, amount:0.2}}>
                <img src='https://qph.cf2.quoracdn.net/main-qimg-2b88e7ec4d2e5f7a3f6626462e7553ba-lq' className='rounded-lg h-[250px]'/>
                <div className='flex justify-center mt-2'><button className='bg-purple-500 hover:bg-purple-600 px-2 py-1 rounded-md text-white w-72' onClick={()=>navigate('/cleaning')}>Room Cleaning</button></div>
              </motion.div>
              <motion.div variants={fadeIn('right', 0.05)} initial="hidden" whileInView={'show'} viewport={{once:true, amount:0.2}}>
                <img src='https://www.checkatrade.com/blog/wp-content/uploads/2021/04/air-vent-cleaning-cost.jpg' className='rounded-lg h-[250px]'/>
                <div className='flex justify-center mt-2'><button className='bg-purple-500 hover:bg-purple-600 px-2 py-1 rounded-md text-white w-72' onClick={()=>navigate('/ac')}>AC Servicing</button></div>
              </motion.div>
              <motion.div variants={fadeIn('right', 0.05)} initial="hidden" whileInView={'show'} viewport={{once:true, amount:0.2}}>
                <img src='https://thumbor.forbes.com/thumbor/fit-in/900x510/https://www.forbes.com/home-improvement/wp-content/uploads/2022/03/featured-image-electrician.jpeg.jpg' className='rounded-lg h-[250px]'/>
                <div className='flex justify-center mt-2'><button className='bg-purple-500 hover:bg-purple-600 px-2 py-1 rounded-md text-white w-72'>Electrical Complaint</button></div>
              </motion.div>
              <motion.div variants={fadeIn('right', 0.05)} initial="hidden" whileInView={'show'} viewport={{once:true, amount:0.2}}>
                <img src={water} className='rounded-lg h-[250px]'/>
                <div className='flex justify-center mt-2'><button className='bg-purple-500 hover:bg-purple-600 px-2 py-1 rounded-md text-white w-72'>Carpentry</button></div>
              </motion.div>
            </div>
          </div>
          </div>
          <div className='mb-24 px-6'>
          <h2 className=' mb-12 mt-36 text-center text-4xl text-purple-500 font-serif' ref={scrollToRefs.ref4}>Amenities</h2>
          <div className='px-10'>
          ...
          <div>
          <h2 className=' mb-12 mt-24 text-center text-4xl text-purple-500 font-serif' ref={scrollToRefs.ref6}>Gallery</h2>
          <div className='px-10'>
          ...
          <div>
          <h2 className=' mb-12 mt-36 text-center text-4xl text-purple-500 font-serif' ref={scrollToRefs.ref7}>Contact Us</h2>
          <div className='mx-32'>
